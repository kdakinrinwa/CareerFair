...
class Mailin
{
  ...
  {
    $this->username = defined('MAILIN_USERNAME') ? MAILIN_USERNAME : '';
    $this->password = defined('MAILIN_PASSWORD') ? MAILIN_PASSWORD : '';
    
    // $this->username = getenv('MAILIN_USERNAME') ?: 'admin@giftrete.com';
    // $this->password = getenv('MAILIN_PASSWORD') ?: '';
