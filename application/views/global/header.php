		...
		<ul class="nav pull-right">
			...
			<li class="dropdown user">
				...
				<ul class="dropdown-menu">
					<li class="divider"></li>
					<li><a target="_blank" href="<?php echo base_url() . '/home'; ?>"><i class="icon-web"></i> Visit Website</a></li>
					<li class="divider"></li>
					<li><a href="<?php echo base_url() . 'admin/changepass'; ?>"><i class="icon-lock"></i> Change Password</a></li>
					<li class="divider"></li>
					<li><a href="<?php echo base_url() . 'admin/signouts'; ?>"><i class="icon-key"></i> Log Out</a></li>
				</ul>
			</li>
